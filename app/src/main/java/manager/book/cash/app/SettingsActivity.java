...
/**
 * Settings activity to check others aps, rate app.
 * Update Key
 * Read about app!
 */
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button mUpdateKey, mRateApp, mShareApp, mCheckMyOtherApps;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUpdateKey = (Button) findViewById(R.id.update_key);
        ...
        mUpdateKey.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mShareApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    String sAux = getString(R.string.about_app);
